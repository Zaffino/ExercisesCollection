...
public class PariDispari extends Thread{
  ...
  public static void main(String[] args){
    ...
    Thread TP = new PariDispari (n + 1, true);                                  // thread che conta i numeri pari
    Thread TD = new PariDispari (n + 1, false);                                 // thread che conta i numeri dispari
